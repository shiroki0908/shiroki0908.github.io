...
const initializeAlbumSectionWithDelegation = () => {
    ...
    const applyDefaultCategory = () => {
      const activeTag = document.querySelector(".album_tags .tag.active");
      const defaultTag = activeTag || document.querySelector(".album_tags .tag");
      ...
      // 切换标签激活状态
      document.querySelectorAll(".album_tags .tag").forEach((el) => el.classList.remove("active"));
